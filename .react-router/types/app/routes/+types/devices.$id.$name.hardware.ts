...
// routes/devices.$id.$name.hardware.tsx
...
type Module = typeof import("../devices.$id.$name.hardware.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/devices.$id.$name.hardware"
  file: "routes/devices.$id.$name.hardware.tsx"
  path: "hardware"
