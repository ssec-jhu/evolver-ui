...
// routes/devices.$id.$name.state.tsx
...
type Module = typeof import("../devices.$id.$name.state.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/devices.$id.$name.state"
  file: "routes/devices.$id.$name.state.tsx"
  path: "state"
