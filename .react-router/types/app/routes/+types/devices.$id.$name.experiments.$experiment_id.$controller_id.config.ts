...
// routes/devices.$id.$name.experiments.$experiment_id.$controller_id.config.tsx
...
type Module = typeof import("../devices.$id.$name.experiments.$experiment_id.$controller_id.config.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2, Parent3, Parent4],
  id: "routes/devices.$id.$name.experiments.$experiment_id.$controller_id.config"
  file: "routes/devices.$id.$name.experiments.$experiment_id.$controller_id.config.tsx"
  path: ":controller_id/config"
  params: {"id": string; "name": string; "experiment_id": string; "controller_id": string} & { [key: string]: string | undefined }
  module: Module
