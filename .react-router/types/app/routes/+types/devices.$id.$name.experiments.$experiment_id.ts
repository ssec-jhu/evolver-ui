...
// routes/devices.$id.$name.experiments.$experiment_id.tsx
...
type Module = typeof import("../devices.$id.$name.experiments.$experiment_id.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2, Parent3],
  id: "routes/devices.$id.$name.experiments.$experiment_id"
  file: "routes/devices.$id.$name.experiments.$experiment_id.tsx"
  path: ":experiment_id"
