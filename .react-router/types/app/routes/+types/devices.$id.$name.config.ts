...
// routes/devices.$id.$name.config.tsx
...
type Module = typeof import("../devices.$id.$name.config.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/devices.$id.$name.config"
  file: "routes/devices.$id.$name.config.tsx"
  path: "config"
