...
// routes/devices.$id.$name.experiments.tsx
...
type Module = typeof import("../devices.$id.$name.experiments.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/devices.$id.$name.experiments"
  file: "routes/devices.$id.$name.experiments.tsx"
  path: "experiments"
  params: {"id": string; "name": string} & { [key: string]: string | undefined }
  module: Module
